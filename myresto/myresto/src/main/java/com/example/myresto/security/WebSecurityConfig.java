...
public class WebSecurityConfig implements WebMvcConfigurer {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
        ...
        .authorizeRequests().antMatchers("/api/history/**").permitAll().and()
        .authorizeRequests().antMatchers("/api/history/all/**").permitAll().and()
        .authorizeRequests().antMatchers("/api/ulasan/**").permitAll().and()
        .authorizeRequests().antMatchers("/api/ulasan/all/**").permitAll().and()
